...
export const metadata: Metadata = {
  ...
  description: 'Thank you for your order! Your fresh microgreens and pet grass are on the way.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Your fresh microgreens and pet grass are on their way. We're excited to be part of your healthy journey!
        </p>

        {/* Order Details */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8 text-left">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Order Confirmation #1234</h2>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <span className="text-gray-900">123 Main St, Anytown, CA 90210</span>
            </div>
        ...
        <div className="bg-blue-50 rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="text-center">
              ...
              <p className="text-gray-700">We'll prepare your fresh microgreens within 24 hours</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-blue-600 font-bold">2</span>
              </div>
              <p className="text-gray-700">You'll receive tracking information via email</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-blue-600 font-bold">3</span>
              </div>
              <p className="text-gray-700">Enjoy your fresh, organic microgreens!</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-50 rounded-lg p-6 mb-8 text-left">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Storage Tips for Maximum Freshness</h2>
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start">
              ...
              Pet grass should be placed in indirect sunlight and watered lightly
            </li>
          </ul>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8">
          <p className="text-gray-600 mb-4">Share your healthy choice with friends!</p>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          <p>
            ...
            <Link href="/contact-us" className="text-green-600 hover:text-green-700 font-medium">
