...
export const metadata: Metadata = {
  ...
  description: 'Learn about our delivery schedules, shipping policies, and subscription management terms.',
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose prose-lg max-w-none">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Fulfillment Policy</h1>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
          <h2 className="text-xl font-semibold text-green-800 mb-2">Quick Summary</h2>
          <p className="text-green-700">
            We deliver fresh microgreens and pet grass weekly with free shipping on subscriptions. 
            Orders can be paused, modified, or cancelled anytime through your account dashboard.
          </p>
        </div>

        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Delivery Schedule</h2>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Weekly Subscriptions</h3>
        <ul className="space-y-2 mb-6">
          ...
          <li>You will receive tracking information 24 hours before delivery</li>
          <li>All subscription deliveries include free shipping</li>
        </ul>

        <h3 className="text-xl font-semibold text-gray-900 mb-3">One-Time Orders</h3>
        <ul className="space-y-2 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Service Areas</h2>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Currently Serving</h3>
        <ul className="space-y-2 mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Delivery Restrictions</h3>
        <ul className="space-y-2 mb-6">
          <li>P.O. Box addresses not accepted for fresh product deliveries</li>
          <li>Military APO/FPO addresses supported with extended delivery times</li>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Subscription Management</h2>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Modifying Your Subscription</h3>
        <ul className="space-y-2 mb-6">
          <li>Changes must be made by 11:59 PM PT, 2 days before your delivery day</li>
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Pausing Your Subscription</h3>
        <ul className="space-y-2 mb-6">
        ...
        <ul className="space-y-2 mb-6">
          ...
          <li>Cancellation must be requested 2 days before your next delivery</li>
          <li>Final delivery will be your last charged order</li>
          <li>Account remains active for 30 days to allow easy reactivation</li>
        </ul>

        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Product Freshness & Quality</h2>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Freshness Guarantee</h3>
        <ul className="space-y-2 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Billing & Payment</h2>
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Pricing Changes</h3>
        <ul className="space-y-2 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Missed Deliveries</h2>
        
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Delivery Attempts</h3>
        <ul className="space-y-2 mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Failed Deliveries</h3>
        <ul className="space-y-2 mb-6">
          <li>Customer charged for failed deliveries due to incorrect address</li>
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Weather-Related Delays</h3>
        <ul className="space-y-2 mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Holiday Schedule</h3>
        <ul className="space-y-2 mb-6">
          <li>Modified delivery schedule during major holidays</li>
          <li>Advance notice provided for holiday schedule changes</li>
          <li>No deliveries on Thanksgiving, Christmas Day, or New Year's Day</li>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <ul className="space-y-2">
            <li><strong>Email:</strong> support@fuelfoodscpg.com</li>
            <li><strong>Phone:</strong> 1-800-FUEL-CPG (1-800-383-5274)</li>
            <li><strong>Hours:</strong> Monday-Friday, 8 AM - 6 PM EST</li>
            <li><strong>Response Time:</strong> Within 24 hours</li>
          </ul>
          
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Emergency Support</h3>
          <p>For urgent delivery issues on weekends, use our online chat feature or email with "URGENT" in the subject line.</p>
        </div>

        <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Terms Updates</h2>
        
        <p className="mb-4">
          This fulfillment policy may be updated periodically to reflect changes in our service offerings or delivery capabilities. 
          Customers will be notified of significant changes via email at least 30 days in advance.
        </p>

        <p className="mb-4">
          For questions about this policy or our fulfillment process, please contact our customer support team. We're here to 
          ensure your experience with FuelFoods CPG exceeds your expectations.
        </p>

        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
          <p className="text-green-800 font-medium">
            Thank you for choosing FuelFoods CPG for your fresh microgreens and pet grass needs. We're committed to 
            delivering the highest quality products with exceptional service.
          </p>
        </div>
      </div>
    </div>
