...
export const metadata: Metadata = {
  ...
  description:
    'A harmonious blend of mild, sweet microgreens perfect for beginners. Includes peas, sunflower, and other gentle flavors.',
};
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-xl text-green-600 font-semibold">
              Mild & Sweet Microgreens Blend
            </p>
          </div>

          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600">
              Our Green Medley is the perfect introduction to microgreens,
              featuring a harmonious blend of mild, sweet varieties that appeal
              to all palates. This gentle mix includes pea shoots, sunflower
              microgreens, and other tender varieties that provide excellent
              nutrition without overwhelming flavors.
            </p>
          </div>

          <div className="bg-fuelfoods-green-50 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full bg-fuelfoods-green-500 text-white py-3 px-6 rounded-lg font-semibold hover:bg-fuelfoods-green-600 transition-colors">
              Add to Cart
            </button>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-600">
            <li className="flex items-start">
              <span className="text-fuelfoods-green-500 mr-2">•</span>
